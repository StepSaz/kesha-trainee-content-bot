...
- Model: `claude-sonnet-5`, temp `0.3`, max_tokens `1024`
...
- Model: `claude-sonnet-5`, temp `0.6`, max_tokens `2048`
...
"boss_command": {
  ...
  "models": {
    "review":  { "model": "claude-sonnet-5", "temperature": 0.3, "max_tokens": 1024 },
    "rewrite": { "model": "claude-sonnet-5", "temperature": 0.6, "max_tokens": 2048 }
  }
}
```
